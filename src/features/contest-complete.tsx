...
export default function ContestComplete() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-emerald-900 via-emerald-800 to-emerald-700 flex items-center justify-center p-6">
            <motion.div
            ...
            >
                ...
                <div className="relative z-10">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center w-24 h-24 bg-linear-to-br from-yellow-400 to-yellow-600 rounded-full mb-8 shadow-lg"
                    >
                    ...
                    >
                        Congratulations to all participants in the Quran Quiz
                        Competition
                    </motion.p>
