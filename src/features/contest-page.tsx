...
import QuestionPicking from "@/features/question-picking";
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4 p-6 text-center">
                ...
                <p className="text-gray-600 max-w-md">
                    Start a contest from the dashboard to load its contestants
                    and questions before running the judge panel.
                </p>
                <Link href="/contests">
